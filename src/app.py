...
activities = {
    ...
    "Basketball Club": {
        "description": "Practice drills, scrimmages and weekend tournaments",
    ...
    # Intellectual (added)
    "Debate Team": {
        "description": "Weekly practice and inter-school debate competitions",
    ...
    "Science Club": {
        ...
        "max_participants": 20,
        "participants": ["oliver@mergington.edu", "eve@mergington.edu"]
    }
}
